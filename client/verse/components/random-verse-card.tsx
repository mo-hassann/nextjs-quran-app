...
export default function RandomVerseCard() {
  return (
    <Link
      href={"/chapter/2/translation?verse=144&chapter=2"}
      className="relative col-span-full overflow-hidden w-full min-h-[220px] h-fit rounded-md font-semibold flex items-center justify-center bg-primary/85 hover:bg-primary/80 hover:shadow-lg shadow-md text-white text-justify p-4 mb-6"
    ...
    >
      ...
      <h2 className="py-5 text-lg sm:text-2xl" style={{ fontFamily: "uthmanic", textAlignLast: "center" }}>
