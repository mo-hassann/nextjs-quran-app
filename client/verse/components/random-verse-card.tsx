...
export default function RandomVerseCard() {
  return (
    <Link
      ...
      className="relative col-span-full overflow-hidden w-full h-[220px] rounded-md text-2xl font-semibold flex items-center justify-center bg-primary/85 hover:bg-primary/80 hover:shadow-lg shadow-md text-white text-justify p-4 mb-6"
