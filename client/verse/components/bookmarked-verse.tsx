...
export default function BookmarkedVerse({ chapterId, verseId, chapterName, transliterationChapterName, isBookmarkedVerse }: props) {
  ...
  return (
    <div className="flex flex-col justify-between h-40 w-full bg-background hover:bg-primary-foreground hover:shadow-md hover:shadow-primary/30 transition-colors p-5 rounded-lg">
      <div className="flex items-center justify-between">
        ...
        <BookmarkAction chapterId={chapterId} verseId={verseId} isBookmarkedVerse={isBookmarkedVerse} />
      </div>
